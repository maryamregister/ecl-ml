...
T1 := ML.Mat.RandMat (Numclass,InputSize);
 OUTPUT  (T1, NAMED ('T1'));
...
predication_class := $.SoftMaxPredict( sample_table_in_numeric_field_format, UpTHETA );
 OUTPUT  (predication_class,  NAMED ('predication_class'));
