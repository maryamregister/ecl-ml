...
//intercept should be considered
...
//input_size = 28*28 pixels +1 label
//class_size = 10 (0 to 9 digits)
//record size = 785*8
//input data
value_record := RECORD
real	f1	;
...
//test phase
 ...
 pred_class := $.SoftMaxPredict( sample_table_in_numeric_field_format, UpTHETA );
OUTPUT  (pred_class,  NAMED ('pred_class'));
