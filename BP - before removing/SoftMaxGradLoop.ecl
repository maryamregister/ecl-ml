...
EXPORT SoftMaxGradLoop(DATASET($.M_Types.MatRecord) d, DATASET($.M_Types.MatRecord) y, REAL8 LAMBDA, REAL8 ALPHA,DATASET($.M_Types.MatRecord) IntTHETA , UNSIGNED LoopNum ) := MODULE
