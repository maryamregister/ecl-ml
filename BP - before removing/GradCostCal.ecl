...
//cost. The input is the desired outputs and also the [{w1 a1=d},{w2 a2},...{[],a_n+1}] datsaet which comes
//from the FF (Feed Forward) Function. 
...
EXPORT GradCostCal(DATASET($.M_Types.MatRecord) y,DATASET($.M_Types.CellMatRec2) wa ) := FUNCTION
