...
softresult_4 := PROJECT (softresult, TRANSFORM (PBblas.Types.Layout_Part4, SELF.mat_part := to4(LEFT.part_rows*LEFT.part_cols,LEFT.mat_part); SELF:=LEFT), LOCAL);
OUTPUT(softresult_4,,'~thor::maryam::mytest::lshtc',CSV(HEADING(SINGLE)), OVERWRITE);
