...
SA_mine4_1 :=DeepLearning.Sparse_Autoencoder_lbfgs_part (f,hl,2,3);
...
END;
OUTPUT (lbfgs_model_mine4_1, ALL);
//OUTPUT (PROJECT(lbfgs_model_mine4_1, TRANSFORM (minfunrec, SELF.real_node := STD.System.Thorlib.Node(); SELF := LEFT), LOCAL));
