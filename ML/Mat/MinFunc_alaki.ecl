...
EXPORT MinFunc_alaki(xout, x0, CostFunc, CostFunc_params='', TrainData ='', TrainLabel='', MaxIter, MethodOptions, prows=0, pcols=0, Maxrows=0, Maxcols=0):=MACRO
...
//check optimality of the first point -> 370 ???
